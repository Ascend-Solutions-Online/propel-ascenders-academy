...
import TestimonialItem from '@/components/testimonial/testimonial-item'
...
const HomeTestimonial: FC = () => {
  ...
  return (
    <Box id="testimonial" sx={{ pb: { xs: 6, md: 10 }, backgroundColor: 'background.paper' }}>
      <Container>
        <Grid container spacing={5} height={710} pt={10} pb={10}>
          ...
          <Grid item xs={12} md={6} sx={{ display: { xs: 'none', md: 'block' } }}>
            <Box sx={{ width: { xs: '100%', md: '90%' } }}>
              <Image
                src="/images/illustrations/3d-female-character-reading-book.png"
                width={520}
                height={540}
                quality={97}
                alt="Testimonial img"
